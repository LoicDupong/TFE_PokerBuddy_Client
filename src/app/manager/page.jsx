...
import { faPause, faPlay, faForwardStep, faBackwardStep, faRotateRight, faRightFromBracket, faPenToSquare, faCircleXmark } from "@fortawesome/free-solid-svg-icons";
...
export default function GameManager() {
    ...
    const avgStack = preset.chipsPerPlayer && playersLeft
        ? Math.floor((preset.chipsPerPlayer * (preset.maxPlayers || 0)) / playersLeft)
        : 0;
    ...
    return (
        <div className="manager">
            ...
            <div className="manager__sidebar left">
                ...
                <p><strong>Players:</strong> {playersLeft} / {preset.maxPlayers}</p>
                <div className="divider"></div>
                <p><strong>Avg Stack:</strong> {avgStack}</p>
                <p><strong>Buy-in:</strong> {preset.buyIn}€</p>
            ...
            <div className="manager__main">
                ...
                <h1>{preset.smallBlind * level} / {preset.bigBlind * level}</h1>
                <small>
            ...
            <div className="manager__sidebar right">
                <div className="manager__item">
                    <p><strong>Level Duration:</strong> <br />{preset.levelDurationMin} min</p>
                    <Link href={"/manager/preset"}>
                        <div className="btn btn--control"><FontAwesomeIcon icon={faPenToSquare} /> Edit</div>
                    </Link>
                    <Link href={"/manager/preset"}>
                        <div className="btn btn--control"><FontAwesomeIcon icon={faCircleXmark} /> End</div>
                    </Link>
                </div>
                <Link href={"/manager/preset"}>
            ...
            <div className="manager__message"><FontAwesomeIcon icon={faRotateRight} /> <small>Rotate your device for the best experience</small></div>
        </div>
    );
}
