...
import { faComment, faDollarSign, faFlagCheckered, faHourglassEnd, faHourglassStart, faMoneyCheckDollar, faRankingStar, faSackDollar, faTrophy, faUserGroup } from "@fortawesome/free-solid-svg-icons";
...
export default function ActiveGameDetails() {
  ...
  useEffect(() => {
    (async () => {
      ...
      const pendingGame = gamesArray.filter(d => d.status === "active")
